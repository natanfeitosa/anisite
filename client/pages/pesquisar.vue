<template>
  <div class="w-full">
    <div class="w-11/12 mx-auto my-2 p-4 rounded-lg shadow-md bg-gray-200">
      ...
      />
      <div class="w-full">
        <button v-if="false" class="text-purple-500 background-transparent font-bold uppercase px-3 py-1 text-xs outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button" @click="resetAll">
